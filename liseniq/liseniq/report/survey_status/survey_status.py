...
def get_columns(filters):
	...
	if filters and filters.get("demographic1"):
		dem = frappe.get_value("qp_IQ_DemographicType", filters.get("demographic1"), "dt_title")
		columns.append({
	...
	if filters and filters.get("demographic2"):
		dem = frappe.get_value("qp_IQ_DemographicType", filters.get("demographic2"), "dt_title")
		columns.append({
